...
export default function(product_id){
    ...
    if(result !== null && $("#countDownDate_"+product_id).length == 1) {
        ...
        $('#countDownDate_countDownDate_'+product_id).show();
        ...
        var x = setInterval(function() {
            ...
            $('.countDownDate_'+product_id).html(strCountDown);
            $('.countDown_'+product_id).removeClass('hide');
